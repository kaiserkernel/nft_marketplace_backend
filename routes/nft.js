...
const { mintNFT, getAllNFT, getNFTofCollection, getOwnNFT, setFixedPrice, buyNFT, setAuction, bidNFT, getTopAuctions, setNotForSale } = require("../controllers/nftController");
...
router.post("/not_for_sale", setNotForSale);
